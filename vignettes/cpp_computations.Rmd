...
print('Time required to compute 10000 x 10000 matrix')
start_time <- proc.time()
x <- yasss:::cpp_fibo_df_pass(1000, 1000, yasss:::cpp_fibo)
print(proc.time() - start_time)
```
...
start_time <- proc.time()
x <- mutator_uniform_fun(paste(rep('A', 5000000), sep = '', collapse = ''), 0.1)
print(proc.time() - start_time)
```
...
start_time <- proc.time()
x <- yasss:::cpp_mutator_uniform_fun(paste(rep('A', 50000000), sep = '', collapse = ''), 0.1)
print(proc.time() - start_time)
```
