...
* `clara2` : The key summary metrics of the call to clara:
  - `avg_within_cluster`: The average of all the pairwise distances between all the elements in the same cluster.
  - `avg_between_cluster`: The average of all the pairwise distances between all the elements not in the same cluster.
